                ...
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <ul class="py-1">
                            ...
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/technocrats_institute_of technology,Bhopal/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                ...
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <ul class="py-1">
                            ...
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/Technocrats_institute_of_technology,Bhopal/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
